...
export function Sidebar({ components }: SidebarProps) {
    ...
    return (
        <div className={classNames('relative')}>
            <div className={classNames('  z-10 h-[calc(100vh-110px)] overflow-y-auto')}>
                <aside
                    ref={panelRef}
                    style={{ width }}
                ...
                >
                    ...
                    <div className="  right-0 top-0 h-full w-64 flex flex-col bg-white border-r border-gray-200 shadow-sm ">
                        <Toolbar />
            ...
            <div className=" w-full absolute bottom-0 mt-auto p-3 border-t border-gray-100">
                <DeletePageButton />
            </div>
        </div>
    );
