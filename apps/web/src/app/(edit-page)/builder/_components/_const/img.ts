...
const PLACEHOLDER_IMG_WIDTH_PX = 300;
const PLACEHOLDER_IMG_HEIGHT_PX = 200;
const PLACEHOLDER_IMG_MAX_WIDTH_PERCENT = 100;
const PLACEHOLDER_IMG_MIN_WIDTH_PERCENT = 1;
