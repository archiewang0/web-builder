...
export interface BorderWidthOptionsProps {
    borderWidth?: string;
    onWidthChange: StyleChangeHandler;
    classname?: string;
}

const parsePx = (v?: string) => (v ? parseInt(v, 10) || 0 : 0);

export function BorderWidthOptions({
    borderWidth,
    onWidthChange,
    classname,
}: BorderWidthOptionsProps) {
    return (
        <div className={classname}>
            <div className="flex items-center space-x-2">
                ...
                <input
                    ...
                    min="0"
                    onChange={(e) => onWidthChange({ borderWidth: `${e.target.value}px` })}
                />
