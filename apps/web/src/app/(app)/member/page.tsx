...
import { useMemberPages } from './use-member-pages';
import { useCreatePage } from '@/app/(app)/_hooks/use-create-page';
import { deleteAccountRequest } from './delete-account';
...
export default function MemberPage() {
    ...
    const { pages, isLoading, deletePage } = useMemberPages(Boolean(user));
